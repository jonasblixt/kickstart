...
kickstart_build:
	...
	@make -C /pkg/src/ CROSS_COMPILE=aarch64-linux-gnu-
	@cp /pkg/src/build/kickstart /ksbuild/build

kickstart_clean:
	@make -C /pkg/src/initrd CROSS_COMPILE=aarch64-linux-gnu- clean
	@make -C /pkg/src/ CROSS_COMPILE=aarch64-linux-gnu- clean
